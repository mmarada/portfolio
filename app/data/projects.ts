export type Project = {
  ...
  accentColor: string;    // for tag/link highlight
  span?: "wide";          // featured tiles span 2 cols
};
...
export const projects: Project[] = [
  {
    ...
    description:
      "Turns Claude Code into a full job search command center — evaluates 740+ offers with A–F scoring, generates ATS-optimized CVs per job description, and scrapes 45+ portals via Playwright. Used to land a Head of Applied AI role.",
  ...
  },
  {
    ...
    tags: ["LangGraph", "FastMCP", "Python", "SQLite", "Flask"],
    category: "ai",
  ...
  },
  {
    ...
    description:
      "GPT-4 Vision tool that grades consulting case solutions across Structure, Quant Analysis, Business Judgment & Communication — accepts PDFs and images with drag-and-drop.",
  ...
  },
  {
    ...
    description:
      "Models team form, player ratings, and head-to-head data to generate win/draw/loss probabilities for FIFA 26 matchups. Built as a real-time sports analytics layer.",
  ...
  },
  {
    ...
    description:
      "Decoupled React/Node.js chess platform with real-time game logic via WebSockets and an anime-inspired visual identity.",
